...
for a = agents
        ...
        for p = perspays
            ...
            while dest==destnoise&&(dest~=1&&destnoise~=1)
                ...
                while(paygivingnoised>paynotgivingnoised)||prephasenoise
                    ...
                    paynotgivingnoise = 1 + payoffnoise(1,1);
    ...
    %save(['task2/task2-a-' num2str(arg.n) '.mat'], 'datamat');
